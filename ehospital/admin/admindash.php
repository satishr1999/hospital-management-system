...
?>
	...
	<a class = "a10" href = "../index.php">Go to Homepage</a>
...
?>
	...
	<h3 style = "margin-top : -400px; margin-left : 200px; " align = "left">
	<a class = "alink" title = "Notifications" href = "notification.php">Notifications</a>
	</h3>
